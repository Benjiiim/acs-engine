...
|platformUpdateDomainCount|no|Specifies the number of Update Domain of the Availability Set|
|platformFaultDomainCount|no|Specifies the number of Fault Domain of the Availability Set|
